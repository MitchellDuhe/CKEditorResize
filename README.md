repository created so that the resize image feature on the CKEditor can be used with strapi.
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `co24q5d3dnua-h1terkgf6pad`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
